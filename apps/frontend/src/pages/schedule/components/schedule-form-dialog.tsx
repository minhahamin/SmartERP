...
import { useCreateSchedule } from '@/pages/schedule/hooks/use-schedule';
import { useAuthStore } from '@/stores/auth-store';
import { SCHEDULE_TYPE_LABEL, type ScheduleType, type ScheduleVisibility } from '@/mocks/schedules';
...
function ScheduleFormDialog({ open, onOpenChange, defaultDate }: ScheduleFormDialogProps) {
